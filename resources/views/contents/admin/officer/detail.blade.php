            ...
            <div class="col-xl">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4 class="card-title mb-0">Profil Petugas</h4>
                                        ...
                                        <div class="profile-mail">
                                            <div class="media align-items-center">
                                                ...
                                                <img class="img-100 img-fluid m-r-20 rounded-circle update_img_0"
                                                    src="/admins/images/dashboard/1.png" alt="">


                                                <div class="media-body mt-0">
                                                    <h5><span class="first_name_0">{{ $petugas->nama_petugas }} (</span>

                                                        <span class="last_name_0">{{ $petugas->username }}
                                                            )</span>
                                                    ...
                                                    <ul>
                                                        <li><a href="/admin/petugas/edit/{{ $petugas->id_petugas }}"
                                                                onclick="editContact(0)">Edit</a></li>
                                                        <li><a href="/admin/petugas/delete/{{ $petugas->id_petugas }}"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#modalDelete{{ $petugas->id_petugas }}">Hapus</a>
                                                        </li>

                                                        {{-- modal delete --}}
                                                        <div class="modal fade"
                                                            id="modalDelete{{ $petugas->id_petugas }}" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="/admin/petugas/delete/{{ $petugas->id_petugas }}"
                                                                            method="POST">
                                                                            @method('delete')
                                                                            @csrf
                                            ...
                                            <div class="email-general">
                                                ...
                                                <ul>
                                                    <li>Alamat <span
                                                            class="font-primary first_name_0">{{ $petugas->alamat }}</span>
                                                    </li>
                                                    <hr>
                                                    <li>No Telp<span class="font-primary">{{ $petugas->telp }}</span>
                                                    </li>
                                                    <hr>
                                                    <li>Level<span class="font-primary"> {{ $petugas->level }}
                    ...
                    <div class="form-footer text-end">
                        <a href="{{ url('/admin/petugas') }}"><button
