            ...
            <div class="col-xl">
                <div class="card">
                                  ...
                                  <div class="profile-mail">
                                    <div class="media align-items-center">
                                      ...
                                      <div class="media-body mt-0">
                                        <h5>
                                            <span class="first_name_0">{{ $society->nama }} (</span>
                                            
                                            <span class="last_name_0">{{ $society->username }}
                                                
                                        )</span>
                                        @if ($society->foto_ktp != '' || $society->tgl_lahir )
                                        <span class="text-sm-success rounded" >Terverifikasi</span>
                                         @else
                                         <span class="text-danger rounded">Belum verifikasi</span>
                                        @endif
                                        </h5>
                                        <p class="email_add_0">{{ $society->nik }}</p>
                                        <ul>
                                          <li><a href="/admin/masyarakat/delete/{{ $society->nik }}" onclick="editContact(0)">Edit</a></li>
                                          <li><a href="/admin/masyarakat/delete/{{ $society->nik }}" data-bs-toggle="modal" data-bs-target="#modalDelete{{ $society->nik }}">Hapus</a>
                                        </li>

                                          {{-- modal delete --}}
                                   <div class="modal fade" id="modalDelete{{ $society->nik }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Apakah anda yakin ingin menghapus {{ $society->nama }} ?</p>
                                        </div>
                                        <div class="modal-footer">
                                          <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Batal</button>
                                          <form action="/admin/masyarakat/delete/{{ $society->nik }}" method="POST">
                                            @method('delete')
                                            @csrf
                                    ...
                                    <div class="email-general">
                                      ...
                                      <ul>
                                        <li>Email <span class="font-primary first_name_0">{{ $society->email }}</span>
                                        </li>
                                        <hr>
                                        <li>Alamat <span class="font-primary first_name_0">{{ $society->alamat }}</span>
                                        </li>
                                        <hr>
                                        ...
                                        <div class="gallery my-gallery card-body row" itemscope="" data-pswp-uid="1">
                                            <figure class="col-xl-3 col-md-4 xl-33" itemprop="associatedMedia" itemscope=""><a href="{{ asset($society->foto_ktp) }}" itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail" src="{{ asset($society->foto_ktp) }}" itemprop="" alt="Image description"></a>
                    ...
                    <div class="form-footer text-end">
                        <a href="{{ url('/admin/masyarakat') }}"><button class="btn btn-primary btn-block">Kembali</button></a>
                    </div>
                </div>
            </div>
        </div>
