            ...
            <div class="col-xl">
                <div class="card">
                                    ...
                                    <div class="media align-items-center">
                                      ...
                                      <div class="media-body mt-0">
                                        ...
                                        <ul>
                                          ...
                                          {{-- modal delete --}}
                                   <div class="modal fade" id="modalDelete{{ $petugas->id_petugas }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Apakah anda yakin ingin menghapus {{ $petugas->nama_petugas }} ?</p>
                                        </div>
                                    ...
                                    <div class="email-general">
                                      ...
                                      <ul>
                                        <li>Alamat <span class="font-primary first_name_0">{{ $petugas->alamat }}</span>
                                        </li>
                                        <hr>
                    ...
                    <div class="form-footer text-end">
                        <a href="{{ url('/admin/petugas') }}"><button class="btn btn-primary btn-block">Kembali</button></a>
                    </div>
                </div>
            </div>
        </div>
